                                                                        ...
                                                                        <div class="card-body">
                                                                              <div class="row">
                                                                                    ...
                                                                                    <div class="col-sm-2 align-self-center d-flex justify-content-center">
                                                                                          <!--imagen-->
                                                                                          <img class="rounded" src="<?php echo 'http://localhost/Proyecto-Lis/recursos/img/' . $carrito[$i]['Imagen'] ?>" style="width:100px;height:100px" />
                                                                                    </div>

                                                                                    <div class="col-sm-4 align-self-center">
                                                                                          <span class="font-wight-bold d-block"></span>
                                                                                          <span><?php echo $carrito[$i]['Nombre'] ?></span>
                                                                                    </div>

                                                                                    <div class="col-sm-2 align-self-center">
                                                                                          <span>$<?php echo  $carrito[$i]['Precio'] ?></span>
                                                                                    </div>
