       ...
       <form role="form" action="{{route('cupon.update',$cupon->IdCuponR)}}" method="POST">
            ...
            <div class="form-group">
                ...
                <div class="input-group">
                    <input type="text" class="form-control" name="IdCuponR" id="IdCuponR" value="{{old('IdCuponR',$cupon->IdCuponR)}}"  placeholder="Ingresa el codigo cupon" >
            ...
            <div class="form-group">
                ...
                <div class="input-group">
                    <input type="text" class="form-control" name="IdEmpresaR" id="IdEmpresaR" value="{{old('IdEmpresaR',$cupon->IdEmpresaR)}}"  placeholder="Ingresa el codigo de la empresa" >
                    <span class="input-group-addon"><span class="glyphicon glyphicon-asterisk"></span></span>
                </div>
            </div>
            <div class="form-group">
            ...
            <div class="form-group">
                ...
                <div class="input-group">
                    <input type="text" class="form-control" id="Disponibilidad" name="Disponibilidad" value="{{old('Disponibilidad',$cupon->Disponibilidad)}}"   placeholder="Ingresa la cantidad disponible">
                    <span class="input-group-addon"><span class="glyphicon glyphicon-asterisk"></span></span>
                </div>
            </div>
            <div class="form-group">
            ...
            <div class="form-group">
                ...
                <div class="input-group">
                    <input type="text" class="form-control" id="CantidadVendido" name="CantidadVendido" value="{{old('CantidadVendido',$cupon->CantidadVendido)}}"   placeholder="Ingresa la cantidad de cupones vendidos">
                    <span class="input-group-addon"><span class="glyphicon glyphicon-asterisk"></span></span>
                </div>
            </div>
            <div class="form-group">
                ...
                <div class="input-group">
                    <input type="text" class="form-control" id="Estado" name="Estado" value="{{old('Estado',$cupon->Estado)}}"  placeholder="Ingresa el estado">
                    <span class="input-group-addon"><span class="glyphicon glyphicon-asterisk"></span></span>
                </div>
            </div>
